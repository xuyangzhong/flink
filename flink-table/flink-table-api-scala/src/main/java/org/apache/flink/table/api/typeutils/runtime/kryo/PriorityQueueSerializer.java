...
package org.apache.flink.table.api.typeutils.runtime.kryo;
 ...
 *
 * <p>The only changes to the code are those that are required to make it compile and pass
 * checkstyle checks in our code base.
 */
@Internal
