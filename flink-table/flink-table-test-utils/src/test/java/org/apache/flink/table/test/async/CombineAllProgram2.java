...
/** ThenCombineProgram. */
public class CombineAllProgram2 extends TestProgram2 {

    private final TestFunction testFunction;

    public CombineAllProgram2(
    ...
    public static void main(String[] args) throws Exception {
        ...
        CombineAllProgram2 test = new CombineAllProgram2(1L, "", env);
        test.run();
    }
}
