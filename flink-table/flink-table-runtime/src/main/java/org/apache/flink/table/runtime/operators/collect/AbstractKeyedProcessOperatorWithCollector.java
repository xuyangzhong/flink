...
@Internal
public abstract class AbstractKeyedProcessOperatorWithCollector<K, IN, OUT>
        extends AbstractUdfStreamOperatorWithCollector<OUT, KeyedProcessFunction<K, IN, OUT>>
    ...
    public AbstractKeyedProcessOperatorWithCollector(KeyedProcessFunction<K, IN, OUT> function) {
        super(function);
    ...
    private class ContextImpl extends KeyedProcessFunction<K, IN, OUT>.Context {
        ...
        public K getCurrentKey() {
            return (K) AbstractKeyedProcessOperatorWithCollector.this.getCurrentKey();
        }
    }
