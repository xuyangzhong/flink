 ...
 * slices and calculate based on the window. See {@link UnsliceWindowAggProcessor} as an example.
 *
 * <p>Note: Currently, the {@link UnslicingWindowOperator} only support session time window.
 */
@Internal
public class UnslicingWindowOperator<K, W> extends AbstractWindowOperator<K, W> {
